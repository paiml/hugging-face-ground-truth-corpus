...
uncertainty estimation, evaluation harness, and evaluating model performance.
...
Examples:
    ...
    'zero_shot'
    >>> from hf_gtc.evaluation import TaskType, OutputFormat
...
from hf_gtc.evaluation.comparison import (
    compare_models as compare_models_statistical,
)
...
from hf_gtc.evaluation.harness import (
    VALID_AGGREGATION_METHODS as VALID_HARNESS_AGGREGATION_METHODS,
)
from hf_gtc.evaluation.harness import (
...
from hf_gtc.evaluation.harness import (
    AggregationMethod as HarnessAggregationMethod,
)
from hf_gtc.evaluation.harness import (
    aggregate_results as aggregate_harness_results,
)
from hf_gtc.evaluation.harness import (
    get_aggregation_method as get_harness_aggregation_method,
)
from hf_gtc.evaluation.harness import (
    list_aggregation_methods as list_harness_aggregation_methods,
)
from hf_gtc.evaluation.harness import (
    validate_aggregation_method as validate_harness_aggregation_method,
)
...
__all__: list[str] = [
    ...
    "VALID_EFFECT_SIZES",
    "VALID_EVALUATION_MODES",
    "VALID_HARNESS_AGGREGATION_METHODS",
    "VALID_LEADERBOARD_TYPES",
    "VALID_METRIC_TYPES",
    "VALID_OUTPUT_FORMATS",
    "VALID_RANKING_METHODS",
    ...
    "get_evaluation_mode",
    "get_fairness_metric",
    "get_harness_aggregation_method",
    "get_leaderboard_type",
    "get_localization_type",
    ...
    "list_evaluation_modes",
    "list_fairness_metrics",
    "list_harness_aggregation_methods",
    "list_leaderboard_types",
    "list_localization_types",
    ...
    "validate_fairness_constraint",
    "validate_fairness_metric",
    "validate_harness_aggregation_method",
    "validate_harness_config",
    "validate_harness_stats",
    "validate_humaneval_config",
    "validate_latency_breakdown",
